...
calls & 69,840 & 2.93 & 2.93 & 4,801 & -- & 0 & 0 \\ 
%
...
calls & 6.3\% & 2.38 & 43.9\% & 63 &34 \\ 
\end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
\item calls .. \texttt{\footnotesize /home/jovyan/work/GitRepo/Duke\_CBB520\_HW2/out\_filter/calls\_filter.vcf}
...
%
\hslide{Number of HETs by AF}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{hwe.0}}
