...
#   plot-vcfstats -p /home/jovyan/work/GitRepo/Duke_CBB520_HW2/out_filter/plot_stat /home/jovyan/work/GitRepo/Duke_CBB520_HW2/out_filter/calls_filter.stats
#
# Edit as necessary and recreate the plots by running
#   python plot.py
#
# Title abbreviations:
# 	 0 .. calls .. /home/jovyan/work/GitRepo/Duke_CBB520_HW2/out_filter/calls_filter.vcf
#
...
if plot_SNP_count_by_af:
	...
	if 0 in dat and len(dat[0])>2:
		ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='calls')
		has_data = 1
